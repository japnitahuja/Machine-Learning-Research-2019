...
path_dataset_folder = os.path.join(home,"dataset") #main dataset folder
...
if os.path.exists(path_dataset_folder):
    ...
    for dataset in os.listdir(path_dataset_folder):
        ...
        path_lc_folder = os.path.join(home,"learning_curves")
        ...
        op_file = os.path.join(path_metadata,"learning_curves.txt")
        ...
        if (14*total) >= (15 * abs(no_1-no_0)):
            ...
            op_file.write(str(no_0)+","+str(no_1)+","+str(imbalance)+"\n")
