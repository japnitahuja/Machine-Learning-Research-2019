...
path_knn_folder = os.path.join(path_dataset_folder,"KNN_complex_datasets")
os.makedirs(path_knn_folder, exist_ok=True)

path_knn_img_folder = os.path.join(path_dataset_folder,"KNN_complex_img_datasets")
