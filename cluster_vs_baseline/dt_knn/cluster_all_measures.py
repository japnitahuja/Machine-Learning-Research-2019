...
with open("centroid_wise_acc.txt", "w") as f:
	writer = csv.writer(f)
	writer.writerows(centroid_wise_acc)

with open("centroid_pair.txt", "w") as f:
	writer = csv.writer(f)
