	...
	for cluster in range(4):
		...
		for i in range(len(X)):
			for t_cluster in range(4):
				if cluster != t_cluster:
					for feature in range(11):
						#print(i)
						#print(feature)
						#print(X[int(i)][feature])
						#print(float(X[i][feature]))
						#print(centroids[n0][t_cluster][feature],t_cluster,feature)
						#print(float(centroids[n0][t_cluster][feature]))
						dis += (float(X[i][feature]) - float(centroids[n0][t_cluster][feature]))**2
		print("separation")
		print(dis)