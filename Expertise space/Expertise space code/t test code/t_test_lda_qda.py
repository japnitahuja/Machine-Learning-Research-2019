...
algo1_name = "linear_discriminant_analysis"
algo2_name = "quadratic_discriminant_analysis"
...
for i in range(n):
	...
	#print(algo1_temp)
	#print(algo2_temp)
	t_test = stats.ttest_ind(algo1_temp,algo2_temp)
	#print(t_test)
...
expertise_label_file = "t_test_" + algo1_name + "_vs_" + algo2_name + ".txt"
